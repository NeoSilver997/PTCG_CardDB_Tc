    ...
    <div className="min-h-screen bg-gray-100 p-4">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-bold text-gray-800">PTCG Deck Builder</h1>
          {onClose && (
            <button
              onClick={onClose}
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 max-h-96 overflow-y-auto">
                {filteredCards.map(card => (
                  <div key={card.CardID} className="bg-gray-50 rounded-lg p-3 hover:shadow-md transition-shadow">
                    ...
                    <h3 className="font-medium text-sm mb-1 truncate">{card.Name}</h3>
                ...
                {deck.cards.map(card => (
                  <div key={card.CardID} className="flex items-center justify-between bg-gray-50 rounded p-2">
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-600">{card.CardType}</p>
                    </div>
