...
def normalize_skill_text(skill_text):
    ...
    skill_text = skill_text.replace('那隻寶可夢', '該寶可夢')  # 統一指示代詞
...
# 寫入新CSV文件
output_file = 'cards_output_all_mega_with_effects_smart_merged_final_perfect.csv'
